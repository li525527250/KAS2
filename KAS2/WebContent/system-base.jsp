...
$.ajax({  
    ...
    url : 'SelectPostsByDePartmentID?value='+systemKey, //调用后台控制类的方法  
    dataType : 'json',    
...
$.ajax({  
    type : 'GET',    
    contentType : 'application/json', 
    url : 'SelectModuleByPostIDToAddKpiServlet?value='+systemKey, //调用后台控制类的方法  
    dataType : 'json',    
    success : function(data) {   
    	obj.options.length=0;
    	obj.options.add(new Option("选择模块",0)); 
    $.each(data,function(i,item) {
        obj.options.add(new Option(item.moduleName,item.moduleID));  
         });  
    }  
    });  
} 
...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="AddKpiServlet">
			...
			<div class="tabBar cl">
				...
				<div class="tabCon">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<select name="search_systemKey1" 
								class="select" id="module">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" id="website-title" name="kpiindexName"
								placeholder="控制在25个字、50个字节以内" value="" class="input-text">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2"> <span
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" name="weight" id="website-Keywords" placeholder="数字加百分号(%)"
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" name="span" id="website-Keywords" placeholder="数字加百分号(%)"
								value="" class="input-text">
						</div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea name="indexDefinition"  class="textarea"></textarea>
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2"> <span
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" id="website-uploadfile" name="computationalFormula"
								placeholder="控制在25个字、50个字节以内" value="" class="input-text">
						</div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" id="website-copyright" name="annualObjectives"
								placeholder="百分比(%)或文字描述" value="" class="input-text">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">备季度核算：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" id="website-icp" name="quarterlyAccounting" placeholder="" value=""
								class="input-text">
						</div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" id="website-icp" placeholder="百分比(%)或文字描述" name="currentTarget"
								value="" class="input-text">
						</div>
					</div>
				</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button onClick="layer_close();" class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button><span>${message }</span>
			</div>
		</div>
	</form>
</div>
