...
function getKpiindex(){
	var postiD=$("#posts").val();
	 window.location.href= "SelectKpiindexByPostID?postID="+postiD;
}
...
<body>
	...
	KPI指标管理 <a class="btn btn-success radius r"
	...
	<div class="page-container">
		<div class="text-c">
			<form id="form1">
				...
				<span class="select-box inline"> <select
					name="search_systemKey" onchange="getmodule()" class="select"
					id="department">
		...
		<div class="mt-20">
			<table
				...
				<tbody>
					<c:forEach items="${kpilist }" var="list">
						<tr class="text-c">
	...
	<script type="text/javascript">
		...
		function article_del(obj, id) {
			layer.confirm('确认要删除吗？', function(index) {  
				$.ajax({
					type : 'GET',
					url : 'HideKpiIndexServlet?kpiID='+id+'&datetime=' +new Date().getTime(),
					dataType : 'json',
					contentType: "application/json;charset=utf-8",
					success : function(data) {
						//window.location.href="article-list.jsp";
