		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="/aboutHui.shtml">KAS.KPI</a> <a
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-article">
				...
				<dd>
					<ul>
						<li><a data-href="article-list.html" data-title="用户注册"
							href="javascript:void(0)">用户注册</a></li>
						<li><a data-href="article-list.html" data-title="用户添加"
							href="javascript:void(0)">用户添加</a></li>
						<li><a data-href="article-list.html" data-title="用户修改"
							href="javascript:void(0)">用户修改</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-picture">
				<dt>
					<i class="Hui-iconfont">&#xe613;</i> 公司组织架构管理<i
						class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="picture-list.html" data-title="组织架构添加"
							href="javascript:void(0)">组织架构添加</a></li>
						<li><a data-href="picture-list.html" data-title="组织架构添加"
							href="javascript:void(0)">组织架构添加</a></li>
						<li><a data-href="picture-list.html" data-title="组织架构删除"
							href="javascript:void(0)">组织架构删除</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-product">
				...
				<dd>
					<ul>
						...
						<li><a data-href="SelectDepartmentAllServletToAddKpi"
							data-title="KPI指标添加" href="javascript:void(0)">KPI指标添加</a></li>
					</ul>
				</dd>
			</dl>
		</div>
